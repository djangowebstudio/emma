...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('interface_project', 'number', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.number'
        db.delete_column('interface_project', 'number')
