...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('interface_project', (
        ...
        db.send_create_signal('interface', ['Project'])

        # Adding field 'Order.project'
        db.add_column('interface_order', 'project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.Project'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Project'
        db.delete_table('interface_project')

        # Deleting field 'Order.project'
        db.delete_column('interface_order', 'project_id')
