...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.current_project'
        db.alter_column('interface_user', 'current_project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.Project'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'User.current_project'
        db.alter_column('interface_user', 'current_project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.Project'], blank=True))
    ...
    models = {
        ...
        'interface.user': {
            ...
            'current_project': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['interface.Project']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
